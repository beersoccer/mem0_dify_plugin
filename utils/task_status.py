...
def save_task_status(
    ...
    *,
    ...
    try:
        ...
        result = mem.get_all(user_id="__system__", limit=1, filters=filters)
        ...
        res = mem.add(text, user_id="__system__", metadata=md, infer=False)
...
def update_task_progress(
    ...
    *,
    ...
    """
    _, status = load_task_status(mem, task_id=task_id)
    if not status:
        return False
    ...
    ok, _ = save_task_status(mem, task_status=status)
    return ok
